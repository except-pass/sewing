# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/sewingbot.ipynb (unless otherwise specified).

__all__ = ['logger', 'description', 'command_prefix', 'bot', 'guilds', 'get_all_channel_content',
           'get_all_channel_content', 'get_guild_content', 'sew_threads', 'check_if_time_to_send', 'on_ready',
           'sendnow', 'register', 'unregister', 'email', 'summarize', 'suggest', 'help_text', 'helpme', 'on_message']

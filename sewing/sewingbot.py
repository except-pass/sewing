...
__all__ = ['logger', 'description', 'command_prefix', 'bot', 'guilds', 'get_all_channel_content',
           'get_all_guild_content', 'sew_threads', 'check_if_time_to_send', 'on_ready', 'register', 'unregister',
           'email', 'summarize', 'suggest', 'help_text', 'helpme']
...
async def get_all_guild_content(guild):
    guild_content = {}
...
async def sew_threads(guild):
    guild_content = await get_guild_content(all_guilds)
